...
export function buildTradeStorageSnapshot(trade) {
...
export function buildLegStorageSnapshot(leg) {
...
export function processLoadedData(data, metadata = {}) {
...
export function saveToStorage(metadata = {}) {
    try {
        const payload = {
            version: '2.5',
