...
export function initializeAICoachConsent() {
...
export function showAICoachConsent() {
    const consent = this.aiCoachConsent;
...
export function hideAICoachConsent({ immediate = false } = {}) {
    const consent = this.aiCoachConsent;
...
export function promptAICoachConsent(nextAction = null) {
...
export function acceptAICoachConsent() {
...
export function cancelAICoachConsent() {
    this.aiCoachConsent.pendingAction = null;
    this.hideAICoachConsent();
    this.updateAIChatHeader();
}

export function hasAICoachConsent() {
    return Boolean(this.getAICoachConsent());
}

export function getAICoachConsent() {
    try {
...
export function setAICoachConsent(value) {
    try {
        if (!value) {
