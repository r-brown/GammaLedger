...
1. Download release `gammaledger-<version>.zip` from [Releases](https://github.com/r-brown/GammaLedger/releases)
2. Extract the ZIP file to a folder of your choice
3. Open `index.html` in a modern browser (Chrome, Edge, or Firefox)

Create new database or import your options trading log to start tracking new trades immediately
